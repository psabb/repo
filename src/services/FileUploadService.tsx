...
const commercialExcel = async (storedVectorStoreName: string): Promise<any> => {
  try {
    ...
    const response = await fetch(
      "https://azurebackend.azurewebsites.net/commercialExcel",
      {
        method: "POST",
        headers: {
...
const technicalExcel = async (storedVectorStoreName: string): Promise<any> => {
  try {
    /// Make a request to the server with the vectorStoreName
    const response = await fetch(
      "https://azurebackend.azurewebsites.net/technicalExcel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const legalExcel = async (storedVectorStoreName: string): Promise<any> => {
  try {
    /// Make a request to the server with the vectorStoreName
    const response = await fetch(
      "https://azurebackend.azurewebsites.net/legalExcel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const generalExcel = async (storedVectorStoreName: string): Promise<any> => {
  try {
    /// Make a request to the server with the vectorStoreName
    const response = await fetch(
      "https://azurebackend.azurewebsites.net/generalExcel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
const procurementExcel = async (
  ...
  try {
    /// Make a request to the server with the vectorStoreName
    const response = await fetch(
      "https://azurebackend.azurewebsites.net/procurementExcel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
